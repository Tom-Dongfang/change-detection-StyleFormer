...
from .base.vit import TIMMVisionTransformer,TIMMVisionTransformer_new
from .comer_modules import CNN_Style, CTIBlock, deform_inputs
from models.sync_batchnorm import SynchronizedBatchNorm2d

bn_mom = 0.0003
_logger = logging.getLogger(__name__)

class ViTCoMer_new(TIMMVisionTransformer):
    def __init__(self, pretrain_size=256, num_heads=12, conv_inplane=64, n_points=4, deform_num_heads=6,
        ...
        self.spm = CNN_Style(inplanes=conv_inplane, embed_dim=embed_dim)
        self.interactions = nn.Sequential(*[
            CTIBlock(dim=embed_dim, num_heads=deform_num_heads, n_points=n_points,
                     ...
                     dim_ratio=dim_ratio,
                     cnn_feature_interaction=cnn_feature_interaction if isinstance(cnn_feature_interaction,
                                                                                   bool) else
